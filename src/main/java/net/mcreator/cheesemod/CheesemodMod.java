 ...
 *
 *    Keep the CheesemodModElements object in this class and all calls to this object
...
public class CheesemodMod {
	...
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("cheesemod", "cheesemod"),
			() -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	public CheesemodModElements elements;
	public CheesemodMod() {
		elements = new CheesemodModElements();
		FMLJavaModLoadingContext.get().getModEventBus().register(this);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::init);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientLoad);
		MinecraftForge.EVENT_BUS.register(new CheesemodModFMLBusEvents(this));
	}
